<?php
	include 'plantillaParaCerrados.php';
	require 'conexion.php';
	
	$query = "SELECT ID_INCIDENTE, DOC_USUARIO, FECHA_INCIDENTE, DES_INCIDENCIA, ESTADO_INCIDENCIA, RESOLUCION, TEC_ASIGNADO FROM incidenciastbl WHERE ESTADO_INCIDENCIA='Cerrado'";
